<x-layout>
    <div class="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-md border border-gray-100 my-10">
        <div class="mb-6 border-b border-gray-100 pb-4">
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight">Tambah Barang</h1>
            <p class="text-xs text-gray-500 mt-1">Silakan masukkan data aset atau barang baru ke dalam sistem.</p>
        </div>

        <form action="/barang" method="POST" class="flex flex-col gap-5">
            @csrf
            
            <div class="flex flex-col gap-1.5">
                <label class="text-xs font-bold text-gray-700 tracking-wide">Kode Barang</label>
                <input type="text" name="kode" required 
                    class="border border-gray-300 rounded-lg p-2.5 text-sm focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 text-gray-700 bg-white shadow-sm" placeholder="Contoh: ELK-001">
            </div>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <textarea name="deskripsi" rows="3" 
                    class="border border-gray-300 rounded-lg p-2.5 text-sm focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 text-gray-700 bg-white shadow-sm" placeholder="Tulis deskripsi atau spesifikasi barang..."></textarea>
            </div>
